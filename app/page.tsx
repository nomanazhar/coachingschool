...
export default function Home() {
  return (
    <div className="bg-[#F8F8F8] min-h-screen w-full font-sans no-scrollbar overflow-x-hidden">
      <Navbar />
      {/* First Section */}
      <section className="w-full max-w-screen-2xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-6 md:gap-10 px-3 sm:px-6 md:px-[63px] py-2 sm:py-10 md:py-[30px]">
        <div className="flex-1 flex flex-col justify-center md:pl-4 w-full items-center md:items-start">
          <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-[36px] font-bold leading-tight text-black mb-2 xs:mb-3 sm:mb-4 md:mb-6 text-center md:text-left">Basics Referee School</h1>
          <p className="text-xs xs:text-sm sm:text-base md:text-lg text-zinc-700 mb-2 xs:mb-4 sm:mb-6 md:mb-8 max-w-full md:max-w-[600px] text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 w-full max-w-xs md:max-w-none items-center md:items-start">
        ...
        <div className="flex-1 flex justify-center md:justify-end items-center w-full md:pr-8 mb-4 md:mb-0">
          <Image src="/firstdivimg.png" alt="Program Director" width={320} height={350} className="rounded-lg object-contain w-[150px] h-[120px] sm:w-[220px] sm:h-[180px] md:w-[320px] md:h-[250px] lg:w-[377px] lg:h-[320px]" />
        </div>
      </section>
      {/* Second Section */}
      <section className="w-full max-w-screen-2xl mx-auto flex flex-col items-center justify-center gap-3 sm:gap-4 bg-[#757575] px-2 xs:px-3 sm:px-4 md:px-0">
        <div className="w-full max-w-4xl rounded-xl flex flex-col items-center justify-center px-2 xs:px-3 sm:px-4 py-3 xs:py-4 sm:py-6 mx-auto" style={{background:'rgba(0,0,0,0)', boxSizing:'border-box'}}>
          ...
          <div className="bg-white rounded-xl flex flex-col sm:flex-row items-center sm:items-center gap-4 sm:gap-6 p-2 sm:p-4 w-full max-w-3xl shadow-md">
            <div className="flex justify-center items-center w-[120px] h-[120px] sm:w-[150px] sm:h-[150px] md:w-[180px] md:h-[180px] lg:w-[200px] lg:h-[200px] mb-2 sm:mb-0">
              <Image src="/seconddivimg2.png" alt="Camp Group" width={200} height={200} className="rounded-lg object-cover w-full h-full" />
            </div>
